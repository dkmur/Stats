...
#  echo "Warnings"
  ...
  if [ -z "$SQL_password" ]
  then
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user $STATS_DB -e "INSERT IGNORE INTO error (datetime,RPL,instance,errors,deadlock,failedPogoStop,oldConnection,originTimeout,wsLost,killPogoWait,wokerInitFail,jobFail,killInjection,killSleep,python,noItemDelete,tesseract) VALUES ('$process_hour','60','$MAD_instance_name_2','$errors','$deadlock','$failedPogoStop','$oldConnection','$originTimeout','$wsLost','$killPogoWait','$wokerInitFail','$jobFail','$killInjection','$killSleep','$python','$noItemDelete','$tesseract');"
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove,inGameError,gpsError,pogoNotOpen) VALUES ('$process_hour','60','$MAD_instance_name_2','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove','$inGameError','$gpsError','$pogoNotOpen');"
  else
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO error (datetime,RPL,instance,errors,deadlock,failedPogoStop,oldConnection,originTimeout,wsLost,killPogoWait,wokerInitFail,jobFail,killInjection,killSleep,python,noItemDelete,tesseract) VALUES ('$process_hour','60','$MAD_instance_name_2','$errors','$deadlock','$failedPogoStop','$oldConnection','$originTimeout','$wsLost','$killPogoWait','$wokerInitFail','$jobFail','$killInjection','$killSleep','$python','$noItemDelete','$tesseract');"
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove,inGameError,gpsError,pogoNotOpen) VALUES ('$process_hour','60','$MAD_instance_name_2','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove','$inGameError','$gpsError','$pogoNotOpen');"
  fi
...
#  echo "Warnings"
  ...
  if [ -z "$SQL_password" ]
  then
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user $STATS_DB -e "INSERT IGNORE INTO error (datetime,RPL,instance,errors,deadlock,failedPogoStop,oldConnection,originTimeout,wsLost,killPogoWait,wokerInitFail,jobFail,killInjection,killSleep,python,noItemDelete,tesseract) VALUES ('$process_hour','60','$MAD_instance_name_3','$errors','$deadlock','$failedPogoStop','$oldConnection','$originTimeout','$wsLost','$killPogoWait','$wokerInitFail','$jobFail','$killInjection','$killSleep','$python','$noItemDelete','$tesseract');"
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove,inGameError,gpsError,pogoNotOpen) VALUES ('$process_hour','60','$MAD_instance_name_3','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove','$inGameError','$gpsError','$pogoNotOpen');"
  else
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO error (datetime,RPL,instance,errors,deadlock,failedPogoStop,oldConnection,originTimeout,wsLost,killPogoWait,wokerInitFail,jobFail,killInjection,killSleep,python,noItemDelete,tesseract) VALUES ('$process_hour','60','$MAD_instance_name_3','$errors','$deadlock','$failedPogoStop','$oldConnection','$originTimeout','$wsLost','$killPogoWait','$wokerInitFail','$jobFail','$killInjection','$killSleep','$python','$noItemDelete','$tesseract');"
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove,inGameError,gpsError,pogoNotOpen) VALUES ('$process_hour','60','$MAD_instance_name_3','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove','$inGameError','$gpsError','$pogoNotOpen');"
  fi
...
#  echo "Warnings"
  ...
  if [ -z "$SQL_password" ]
  then
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user $STATS_DB -e "INSERT IGNORE INTO error (datetime,RPL,instance,errors,deadlock,failedPogoStop,oldConnection,originTimeout,wsLost,killPogoWait,wokerInitFail,jobFail,killInjection,killSleep,python,noItemDelete,tesseract) VALUES ('$process_hour','60','$MAD_instance_name_4','$errors','$deadlock','$failedPogoStop','$oldConnection','$originTimeout','$wsLost','$killPogoWait','$wokerInitFail','$jobFail','$killInjection','$killSleep','$python','$noItemDelete','$tesseract');"
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove,inGameError,gpsError,pogoNotOpen) VALUES ('$process_hour','60','$MAD_instance_name_4','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove','$inGameError','$gpsError','$pogoNotOpen');"
  else
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO error (datetime,RPL,instance,errors,deadlock,failedPogoStop,oldConnection,originTimeout,wsLost,killPogoWait,wokerInitFail,jobFail,killInjection,killSleep,python,noItemDelete,tesseract) VALUES ('$process_hour','60','$MAD_instance_name_4','$errors','$deadlock','$failedPogoStop','$oldConnection','$originTimeout','$wsLost','$killPogoWait','$wokerInitFail','$jobFail','$killInjection','$killSleep','$python','$noItemDelete','$tesseract');"
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove,inGameError,gpsError,pogoNotOpen) VALUES ('$process_hour','60','$MAD_instance_name_4','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove','$inGameError','$gpsError','$pogoNotOpen');"
  fi
...
then
  ...
  echo "Processing MAD logs for $MAD_instance_name_6"
  echo ""
#  mkdir -p $folder/tmp
#  grep "$interval" $MAD_path_6/logs/$MAD_instance_name_6-$process_date.log > $folder/tmp/$MAD_instance_name_6.log
  grep "\[$interval" $MAD_path_6/logs/*$MAD_instance_name_6* > $folder/tmp/$MAD_instance_name_6.log
#  echo "Errors"
  errors="$(grep -w \[E\] $folder/tmp/$MAD_instance_name_6.log | grep -v 'Error while getting response from device - Reason' | grep -v 'Cannot start job' | grep -v 'Job for' | wc -l)"
  deadlock="$(grep -w \[E\] $folder/tmp/$MAD_instance_name_6.log | grep -v 'Error while getting response from device - Reason' | grep 'Deadlock found' | wc -l)"
  failedPogoStop="$(grep \[E\] $folder/tmp/$MAD_instance_name_6.log | grep -v 'Error while getting response from device - Reason' | grep 'Failed stopping com.nianticlabs.pokemongo' | wc -l)"
  oldConnection="$(grep \[E\] $folder/tmp/$MAD_instance_name_6.log | grep -v 'Error while getting response from device - Reason' | grep 'Old connection open while a new one is attempted to be established' | wc -l)"
  originTimeout="$(grep \[E\] $folder/tmp/$MAD_instance_name_6.log | grep -v 'Error while getting response from device - Reason' | grep '5 consecutive timeouts or origin'  | wc -l)"
  wsLost="$(grep \[E\] $folder/tmp/$MAD_instance_name_6.log | grep -v 'Error while getting response from device - Reason' | grep 'Websocket connection to'  | wc -l)"
  killPogoWait="$(grep \[E\] $folder/tmp/$MAD_instance_name_6.log | grep -v 'Error while getting response from device - Reason' | grep 'Killed while waiting for pogo start'  | wc -l)"
  wokerInitFail="$(grep \[E\] $folder/tmp/$MAD_instance_name_6.log | grep -v 'Error while getting response from device - Reason' | grep 'Failed initializing worker'  | wc -l)"
  jobFail="$(grep \[E\] $folder/tmp/$MAD_instance_name_6.log | grep -v 'Error while getting response from device - Reason' | grep -i 'Job jobType'  | wc -l)"
  killInjection="$(grep \[E\] $folder/tmp/$MAD_instance_name_6.log | grep -v 'Error while getting response from device - Reason' | grep 'Killed while waiting for injection'  | wc -l)"
  killSleep="$(grep \[E\] $folder/tmp/$MAD_instance_name_6.log | grep -v 'Error while getting response from device - Reason' | grep 'killed while sleeping'  | wc -l)"
  python="$(grep 'Traceback (most recent call last)' $folder/tmp/$MAD_instance_name_6.log |  wc -l)"
  noItemDelete="$(grep \[E\] $folder/tmp/$MAD_instance_name_6.log | grep -v 'Error while getting response from device - Reason' | grep 'Unable to delete any items'  | wc -l)"
  tesseract="$(grep \[E\] $folder/tmp/$MAD_instance_name_6.log | grep -v 'Error while getting response from device - Reason' | grep 'Tesseract Error'  | wc -l)"

#  echo "Warnings"
  warns="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | wc -l)"
  failedData="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Worker failed to retrieve proper data' | wc -l)"
  manyTimeOut="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Too many timeouts' | wc -l)"
  fallingBehind="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'falling behind' | wc -l)"
  if (( $fallingBehind > 0 ))
  then
    maxFalling="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'falling behind' | awk '{print ($NF)}' | jq -s max)"
  else
    maxFalling=0
  fi
  frozenScreen="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Screen is frozen' | wc -l)"
  wsTimeout="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Timeout, increasing timeout-counter' | wc -l)"
  wsConnClosed="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Connection' | grep 'closed' | wc -l)"
  noInject="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Not injected in time - reboot' | wc -l)"
  noPogoStart="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Failed restarting PoGo - reboot device' | wc -l)"
  failedScreenshot="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Failed retrieving screenshot' | wc -l)"
  noPTC="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'No PTC Accounts' | wc -l)"
  failedTopApp="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Failed getting the topmost app' | wc -l)"
  pogoRestartFail="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Restarting PoGo failed - reboot device' | wc -l)"
  screenFailure="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Something wrong with screendetection or pogo failure screen' | wc -l)"
  failedBoxClear="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Failed clearing box' | wc -l)"
  itemDelUnknown="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Deletion not confirmed' | wc -l)"
  noActiveArea="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Cannot find any active area defined for current time' | wc -l)"
  noMainScreen="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Could not get to Mainscreen' | wc -l)"
  noLocAccess="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'has not accessed a location in 500 seconds' | wc -l)"
  noStopProcess="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'has not been processed thrice in a row' | wc -l)"
  failStopOpen="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Giving up on this stop after 5 failures in open_pokestop loop' | wc -l)"
  softban="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Softban' | wc -l)"
  questFull="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Failed getting quest but got items' | wc -l)"
  foundGym="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Tried to open a stop but found a gym instead' | wc -l)"
  noWalkerConfig="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Failed to find a walker configuration' | wc -l)"
  noStop="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'yielding a spinnable stop - likely not standing exactly on top' | wc -l)"
  dupMac="$(grep 'Duplicate MAC' $folder/tmp/$MAD_instance_name_6.log | wc -l)"
  failStopSpin="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'giving up spinning after 4 tries in handle_stop loop' | wc -l)"
  noLogin="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Could not login again' | wc -l)"
  failPostMove="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Worker failed running post_move_location_routine' | wc -l)"
  inGameError="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'In game error detected' | wc -l)"
  gpsError="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'Detected GPS error - reboot device' | wc -l)"
  pogoNotOpen="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_6.log | grep 'PoGo is not opened! Current topmost app' | wc -l)"

  echo "Insert $MAD_instance_name_6 data into DB"
  echo ""
  if [ -z "$SQL_password" ]
  then
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user $STATS_DB -e "INSERT IGNORE INTO error (datetime,RPL,instance,errors,deadlock,failedPogoStop,oldConnection,originTimeout,wsLost,killPogoWait,wokerInitFail,jobFail,killInjection,killSleep,python,noItemDelete,tesseract) VALUES ('$process_hour','60','$MAD_instance_name_6','$errors','$deadlock','$failedPogoStop','$oldConnection','$originTimeout','$wsLost','$killPogoWait','$wokerInitFail','$jobFail','$killInjection','$killSleep','$python','$noItemDelete','$tesseract');"
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove,inGameError,gpsError,pogoNotOpen) VALUES ('$process_hour','60','$MAD_instance_name_6','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove','$inGameError','$gpsError','$pogoNotOpen');"
  else
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO error (datetime,RPL,instance,errors,deadlock,failedPogoStop,oldConnection,originTimeout,wsLost,killPogoWait,wokerInitFail,jobFail,killInjection,killSleep,python,noItemDelete,tesseract) VALUES ('$process_hour','60','$MAD_instance_name_6','$errors','$deadlock','$failedPogoStop','$oldConnection','$originTimeout','$wsLost','$killPogoWait','$wokerInitFail','$jobFail','$killInjection','$killSleep','$python','$noItemDelete','$tesseract');"
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove,inGameError,gpsError,pogoNotOpen) VALUES ('$process_hour','60','$MAD_instance_name_6','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove','$inGameError','$gpsError','$pogoNotOpen');"
  fi
...
then
  ...
  echo "Processing MAD logs for $MAD_instance_name_7"
  echo ""
#  mkdir -p $folder/tmp
#  grep "$interval" $MAD_path_7/logs/$MAD_instance_name_7-$process_date.log > $folder/tmp/$MAD_instance_name_7.log
  grep "\[$interval" $MAD_path_7/logs/*$MAD_instance_name_7* > $folder/tmp/$MAD_instance_name_7.log
#  echo "Errors"
  errors="$(grep -w \[E\] $folder/tmp/$MAD_instance_name_7.log | grep -v 'Error while getting response from device - Reason' | grep -v 'Cannot start job' | grep -v 'Job for' | wc -l)"
  deadlock="$(grep -w \[E\] $folder/tmp/$MAD_instance_name_7.log | grep -v 'Error while getting response from device - Reason' | grep 'Deadlock found' | wc -l)"
  failedPogoStop="$(grep \[E\] $folder/tmp/$MAD_instance_name_7.log | grep -v 'Error while getting response from device - Reason' | grep 'Failed stopping com.nianticlabs.pokemongo' | wc -l)"
  oldConnection="$(grep \[E\] $folder/tmp/$MAD_instance_name_7.log | grep -v 'Error while getting response from device - Reason' | grep 'Old connection open while a new one is attempted to be established' | wc -l)"
  originTimeout="$(grep \[E\] $folder/tmp/$MAD_instance_name_7.log | grep -v 'Error while getting response from device - Reason' | grep '5 consecutive timeouts or origin'  | wc -l)"
  wsLost="$(grep \[E\] $folder/tmp/$MAD_instance_name_7.log | grep -v 'Error while getting response from device - Reason' | grep 'Websocket connection to'  | wc -l)"
  killPogoWait="$(grep \[E\] $folder/tmp/$MAD_instance_name_7.log | grep -v 'Error while getting response from device - Reason' | grep 'Killed while waiting for pogo start'  | wc -l)"
  wokerInitFail="$(grep \[E\] $folder/tmp/$MAD_instance_name_7.log | grep -v 'Error while getting response from device - Reason' | grep 'Failed initializing worker'  | wc -l)"
  jobFail="$(grep \[E\] $folder/tmp/$MAD_instance_name_7.log | grep -v 'Error while getting response from device - Reason' | grep -i 'Job jobType'  | wc -l)"
  killInjection="$(grep \[E\] $folder/tmp/$MAD_instance_name_7.log | grep -v 'Error while getting response from device - Reason' | grep 'Killed while waiting for injection'  | wc -l)"
  killSleep="$(grep \[E\] $folder/tmp/$MAD_instance_name_7.log | grep -v 'Error while getting response from device - Reason' | grep 'killed while sleeping'  | wc -l)"
  python="$(grep 'Traceback (most recent call last)' $folder/tmp/$MAD_instance_name_7.log |  wc -l)"
  noItemDelete="$(grep \[E\] $folder/tmp/$MAD_instance_name_7.log | grep -v 'Error while getting response from device - Reason' | grep 'Unable to delete any items'  | wc -l)"
  tesseract="$(grep \[E\] $folder/tmp/$MAD_instance_name_7.log | grep -v 'Error while getting response from device - Reason' | grep 'Tesseract Error'  | wc -l)"

#  echo "Warnings"
  warns="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | wc -l)"
  failedData="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Worker failed to retrieve proper data' | wc -l)"
  manyTimeOut="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Too many timeouts' | wc -l)"
  fallingBehind="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'falling behind' | wc -l)"
  if (( $fallingBehind > 0 ))
  then
    maxFalling="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'falling behind' | awk '{print ($NF)}' | jq -s max)"
  else
    maxFalling=0
  fi
  frozenScreen="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Screen is frozen' | wc -l)"
  wsTimeout="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Timeout, increasing timeout-counter' | wc -l)"
  wsConnClosed="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Connection' | grep 'closed' | wc -l)"
  noInject="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Not injected in time - reboot' | wc -l)"
  noPogoStart="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Failed restarting PoGo - reboot device' | wc -l)"
  failedScreenshot="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Failed retrieving screenshot' | wc -l)"
  noPTC="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'No PTC Accounts' | wc -l)"
  failedTopApp="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Failed getting the topmost app' | wc -l)"
  pogoRestartFail="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Restarting PoGo failed - reboot device' | wc -l)"
  screenFailure="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Something wrong with screendetection or pogo failure screen' | wc -l)"
  failedBoxClear="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Failed clearing box' | wc -l)"
  itemDelUnknown="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Deletion not confirmed' | wc -l)"
  noActiveArea="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Cannot find any active area defined for current time' | wc -l)"
  noMainScreen="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Could not get to Mainscreen' | wc -l)"
  noLocAccess="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'has not accessed a location in 500 seconds' | wc -l)"
  noStopProcess="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'has not been processed thrice in a row' | wc -l)"
  failStopOpen="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Giving up on this stop after 5 failures in open_pokestop loop' | wc -l)"
  softban="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Softban' | wc -l)"
  questFull="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Failed getting quest but got items' | wc -l)"
  foundGym="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Tried to open a stop but found a gym instead' | wc -l)"
  noWalkerConfig="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Failed to find a walker configuration' | wc -l)"
  noStop="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'yielding a spinnable stop - likely not standing exactly on top' | wc -l)"
  dupMac="$(grep 'Duplicate MAC' $folder/tmp/$MAD_instance_name_7.log | wc -l)"
  failStopSpin="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'giving up spinning after 4 tries in handle_stop loop' | wc -l)"
  noLogin="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Could not login again' | wc -l)"
  failPostMove="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Worker failed running post_move_location_routine' | wc -l)"
  inGameError="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'In game error detected' | wc -l)"
  gpsError="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'Detected GPS error - reboot device' | wc -l)"
  pogoNotOpen="$(grep -w \[W\] $folder/tmp/$MAD_instance_name_7.log | grep 'PoGo is not opened! Current topmost app' | wc -l)"

  echo "Insert $MAD_instance_name_7 data into DB"
  echo ""
  if [ -z "$SQL_password" ]
  then
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user $STATS_DB -e "INSERT IGNORE INTO error (datetime,RPL,instance,errors,deadlock,failedPogoStop,oldConnection,originTimeout,wsLost,killPogoWait,wokerInitFail,jobFail,killInjection,killSleep,python,noItemDelete,tesseract) VALUES ('$process_hour','60','$MAD_instance_name_7','$errors','$deadlock','$failedPogoStop','$oldConnection','$originTimeout','$wsLost','$killPogoWait','$wokerInitFail','$jobFail','$killInjection','$killSleep','$python','$noItemDelete','$tesseract');"
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove,inGameError,gpsError,pogoNotOpen) VALUES ('$process_hour','60','$MAD_instance_name_7','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove','$inGameError','$gpsError','$pogoNotOpen');"
  else
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO error (datetime,RPL,instance,errors,deadlock,failedPogoStop,oldConnection,originTimeout,wsLost,killPogoWait,wokerInitFail,jobFail,killInjection,killSleep,python,noItemDelete,tesseract) VALUES ('$process_hour','60','$MAD_instance_name_7','$errors','$deadlock','$failedPogoStop','$oldConnection','$originTimeout','$wsLost','$killPogoWait','$wokerInitFail','$jobFail','$killInjection','$killSleep','$python','$noItemDelete','$tesseract');"
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove,inGameError,gpsError,pogoNotOpen) VALUES ('$process_hour','60','$MAD_instance_name_7','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove','$inGameError','$gpsError','$pogoNotOpen');"
  fi
