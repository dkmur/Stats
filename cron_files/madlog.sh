...
#  echo "Warnings"
  ...
  then
    ...
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove) VALUES ('$process_hour','60','$MAD_instance_name_2','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove');"
  else
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO error (datetime,RPL,instance,errors,deadlock,failedPogoStop,oldConnection,originTimeout,wsLost,killPogoWait,wokerInitFail,jobFail,killInjection,killSleep,python,noItemDelete,tesseract) VALUES ('$process_hour','60','$MAD_instance_name_2','$errors','$deadlock','$failedPogoStop','$oldConnection','$originTimeout','$wsLost','$killPogoWait','$wokerInitFail','$jobFail','$killInjection','$killSleep','$python','$noItemDelete','$tesseract');"
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove) VALUES ('$process_hour','60','$MAD_instance_name_2','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove');"
  fi
...
#  echo "Warnings"
  ...
  then
    ...
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove) VALUES ('$process_hour','60','$MAD_instance_name_3','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove');"
  else
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO error (datetime,RPL,instance,errors,deadlock,failedPogoStop,oldConnection,originTimeout,wsLost,killPogoWait,wokerInitFail,jobFail,killInjection,killSleep,python,noItemDelete,tesseract) VALUES ('$process_hour','60','$MAD_instance_name_3','$errors','$deadlock','$failedPogoStop','$oldConnection','$originTimeout','$wsLost','$killPogoWait','$wokerInitFail','$jobFail','$killInjection','$killSleep','$python','$noItemDelete','$tesseract');"
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove) VALUES ('$process_hour','60','$MAD_instance_name_3','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove');"
  fi
...
#  echo "Warnings"
  ...
  then
    ...
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove) VALUES ('$process_hour','60','$MAD_instance_name_4','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove');"
  else
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO error (datetime,RPL,instance,errors,deadlock,failedPogoStop,oldConnection,originTimeout,wsLost,killPogoWait,wokerInitFail,jobFail,killInjection,killSleep,python,noItemDelete,tesseract) VALUES ('$process_hour','60','$MAD_instance_name_4','$errors','$deadlock','$failedPogoStop','$oldConnection','$originTimeout','$wsLost','$killPogoWait','$wokerInitFail','$jobFail','$killInjection','$killSleep','$python','$noItemDelete','$tesseract');"
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove) VALUES ('$process_hour','60','$MAD_instance_name_4','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove');"
  fi
...
#  echo "Warnings"
  ...
  then
    ...
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove) VALUES ('$process_hour','60','$MAD_instance_name_5','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove');"
  else
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO error (datetime,RPL,instance,errors,deadlock,failedPogoStop,oldConnection,originTimeout,wsLost,killPogoWait,wokerInitFail,jobFail,killInjection,killSleep,python,noItemDelete,tesseract) VALUES ('$process_hour','60','$MAD_instance_name_5','$errors','$deadlock','$failedPogoStop','$oldConnection','$originTimeout','$wsLost','$killPogoWait','$wokerInitFail','$jobFail','$killInjection','$killSleep','$python','$noItemDelete','$tesseract');"
    mysql -h$DB_IP -P$DB_PORT -u$SQL_user -p$SQL_password $STATS_DB -e "INSERT IGNORE INTO warning (datetime,RPL,instance,warns,failedData,manyTimeOut,fallingBehind,maxFalling,frozenScreen,wsTimeout,wsConnClosed,noInject,noPogoStart,failedScreenshot,noPTC,failedTopApp,pogoRestartFail,screenFailure,failedBoxClear,itemDelUnknown,noActiveArea,noMainScreen,noLocAccess,noStopProcess,failStopOpen,softban,questFull,foundGym,noWalkerConfig,noStop,dupMac,failStopSpin,noLogin,failPostMove) VALUES ('$process_hour','60','$MAD_instance_name_5','$warns','$failedData','$manyTimeOut','$fallingBehind','$maxFalling','$frozenScreen','$wsTimeout','$wsConnClosed','$noInject','$noPogoStart','$failedScreenshot','$noPTC','$failedTopApp','$pogoRestartFail','$screenFailure','$failedBoxClear','$itemDelUnknown','$noActiveArea','$noMainScreen','$noLocAccess','$noStopProcess','$failStopOpen','$softban','$questFull','$foundGym','$noWalkerConfig','$noStop','$dupMac','$failStopSpin','$noLogin','$failPostMove');"
  fi
