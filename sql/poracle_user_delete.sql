delete from poracle.monsters where id in (select id from poracle.humans where name = 'XXA');
delete from poracle.quest where id in (select id from poracle.humans where name = 'XXA');
delete from poracle.incident where id in (select id from poracle.humans where name = 'XXA');
delete from poracle.raid where id in (select id from poracle.humans where name = 'XXA');
delete from poracle.egg where id in (select id from poracle.humans where name = 'XXA');
