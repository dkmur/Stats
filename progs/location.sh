...
echo "Enter Area - Enter defaults to $DEFAULT_AREA"
...
echo ""
sed -e s/rmdb/$MAD_DB/ -e s/pogodb/$STATS_DB/ -e s/XXA/$DB/ -e s/XXB/$res/ -e s/XXC/$area/ $PATH_TO_STATS/sql/location.sql > $Home/temp.sql
