...
insert into pogodb.pokemon_history_temp (encounter_id,spawnpoint_id,pokemon_id,latitude,longitude,CONVERT_TZ(disappear_time, '+00:00', @@global.time_zone),individual_attack,individual_defense,individual_stamina,move_1,move_2,cp,cp_multiplier,weight,height,gender,form,costume,catch_prob_1,catch_prob_2,catch_prob_3,rating_attack,rating_defense,weather_boosted_condition,CONVERT_TZ(last_modified, '+00:00', @@global.time_zone)) 
...
CONVERT_TZ(pogodb.pokemon_history_temp.disappear_time, '+00:00', @@global.time_zone)=new.disappear_time,
...
CONVERT_TZ(pogodb.pokemon_history_temp.last_modified, '+00:00', @@global.time_zone)=new.last_modified
where
